  ...
  return (
    <div className="dark:bg-dark-card shadow-dark-gray font-kumbh relative space-y-6 rounded bg-white p-6 shadow-2xl/10 md:px-10 dark:shadow-xs">
      <section className="space-y-6 md:space-y-6">
        <div className="flex flex-col gap-y-4 md:justify-between md:items-center md:flex-row md:gap-6">
          <div className="space-y-1">
            ...
            <p className="text-title dark:text-dark-title font-bold md:text-lg capitalize text-wrap">
